...
import com.example.apporientdb.repository.TitlePrincipalsBase;
import com.example.apporientdb.repository.TitlePrincipalsRepository;
...
public class TitlePrincipalsService implements TitlePrincipalsBase {
    ...
    public String delete(String id) {
        ...
        long start = System.nanoTime();
        titlePrincipalsRepository.delete(titlePrincipals);
        long end = System.nanoTime();
        double a = (end - start)/1000;
    ...
    public OutputRow update(String id, String category) {
        ...
        long end = System.nanoTime();
        return new OutputRow((end-start)/1000, 1, nameBasics);
    }
}
